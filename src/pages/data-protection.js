...
const DataProtectionPage = () => (
  <Layout>
    ...
    <Section>
      ...
      <p>Effective date: April 04, 2019</p>

      <p>
        Julia Janssen ("us", "we", or "our") operates the
        https://juliajanssen.netlify.com/ website (hereinafter referred to as
        the "Service").
      </p>
      ...
      <p>
        ...
        have associated with that data. The Privacy Policy for Julia Janssen has
      ...
      <p>
        ...
        https://juliajanssen.netlify.com/
      </p>
      ...
      <ul>
        <li>
          ...
          <p>
            Service is the https://juliajanssen.netlify.com/ website operated by
            Julia Janssen
          </p>
        </li>
        <li>
      ...
      <p>Julia Janssen uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        Julia Janssen will take all steps reasonably necessary to ensure that
      ...
      <p>
        Julia Janssen may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Julia Janssen</li>
        <li>
      ...
      <ul>
        <li>By email: juliakimjanssen@hotmail.com</li>
      </ul>
      <p />
      <h1>Disclaimer</h1>
